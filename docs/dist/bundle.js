            ...
            },
            {
              ...
              value: function(e, t, n, r) {
                try {
                  ...
                  var h = Math.floor(20 - 2 * a),
                    d = Math.ceil(h / 2);
                  if (h > 2) {
                    var v = e.createRadialGradient(c, l, 0, c, l, d);
                    v.addColorStop(0, 'rgba(255,255,255,1)'), v.addColorStop(1, 'rgba(0,0,0,0'), (e.fillStyle = v);
                  } else (h = 2), (e.fillStyle = 'White');
                  e.fillRect(c - d, l - d, h, h);
                } catch (e) {
