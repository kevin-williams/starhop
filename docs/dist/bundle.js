!(function(e) {
        ...
        function t() {
          ...
          return (
            ...
            (r.onMouseUp = function(e) {
              console.log('MouseUp=', e), r.setState({ dragging: !1 });
            }),
            (a = n),
            i(r, a)
          );
  ...
  function(e, t, n) {
    ...
    var i = n(113),
      ...
      u = n(497),
      s = { fov: 7, magLimit: 8, width: 600, height: 600 },
      c = { fov: 1.4, magLimit: 12, width: 300, height: 300, scopeType: 'Dobsonian' },
      l = (t.defaultState = {
        stars: [],
        dsos: [],
        view: s,
