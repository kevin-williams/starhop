!(function(e) {
    ...
    (function(t) {
      ...
      var o = n(24),
        ...
        u = {
          adapter: (function() {
            var e;
            return 'undefined' != typeof XMLHttpRequest ? (e = n(187)) : void 0 !== t && (e = n(187)), e;
          })(),
          transformRequest: [
            function(e, t) {
              return (
    ...
    (function(t, r) {
      ...
      function u(e, t) {
        ...
        (this.highWaterMark = r || 0 === r ? r : o),
          ...
          (this.encoding = null),
          e.encoding &&
            (H || (H = n(199).StringDecoder), (this.decoder = new H(e.encoding)), (this.encoding = e.encoding));
      }
      function s(e) {
  ...
  function(e, t, n) {
    ...
    (function(e) {
      ...
      if ((n(203), n(400), n(401), e._babelPolyfill)) throw new Error('only one instance of babel-polyfill is allowed');
      e._babelPolyfill = !0;
  ...
  function(e, t, n) {
    n(402), (e.exports = n(28).RegExp.escape);
  },
  function(e, t, n) {
    var r = n(0),
      o = n(403)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
  ...
  function(e, t, n) {
    ...
    var u,
      ...
      _ = n(458),
      C = (r(_), n(459)),
      S = { fov: 7, magLimit: 8, width: 600, height: 600 },
      O = { fov: 1.4, magLimit: 12, width: 300, height: 300, scopeType: 'Dobsonian' },
      x = [];
    t.default =
      (0, p.connect)(
        function(e) {
        ...
        {
          getStars: E.getStars,
          getDeepSpaceObjects: E.getDeepSpaceObjects,
          updateView: E.updateView,
          updateEyepieceView: E.updateEyepieceView,
          updateSelectedHop: E.updateSelectedHop,
        }
      )(
        (u = (function(e) {
          function t() {
            ...
            return (
              ...
              (r.loadHopData = function(e) {
                var t = C[e.value];
                r.props.updateSelectedHop(t), r.props.getStars(t.starMapQuery);
                var n = s({}, S, { ra: t.startingLocation.ra, dec: t.startingLocation.dec });
                console.log('myFinderView', n), r.props.updateView(n);
                var o = s({}, O, { ra: t.startingLocation.ra, dec: t.startingLocation.dec });
                console.log('myEyepieceView', o), r.props.updateEyepieceView(o);
              }),
              (r.handleScopeType = function(e) {
                var t = e.target.value;
                console.log('Change scopeType=' + t);
                var n = r.props.starhop.eyepieceView;
                (n.scopeType = t), r.props.updateEyepieceView(n);
              }),
              (r.moveUp = function(e) {
                var t = r.props.starhop.eyepieceView,
                  n = r.props.starhop.view;
                (t.dec = t.dec + 0.1),
                  (n.dec = t.dec),
                  console.log('showing new view=', t),
                  r.props.updateEyepieceView(t),
                  r.props.updateView(n);
              }),
              (r.moveDown = function(e) {
                var t = r.props.starhop.eyepieceView,
                  n = r.props.starhop.view;
                (t.dec = t.dec - 0.1),
                  (n.dec = t.dec),
                ...
                value: function() {
                  console.log('starting load DSO action'),
                    ...
                    Object.entries(C).map(function(e) {
                      console.log('hopData entry', e), x.push({ value: e[0], label: e[0] });
                    });
                },
              },
              {
              ...
              value: function(e, t, n) {
                ...
                if (!(Number(t.magLimit) < Number(c))) {
                  ...
                  if (l > 2) {
                    var f = Math.floor(l / 2),
                      p = e.createRadialGradient(u + f, s + f, 0, u + f, s + f, f);
                    p.addColorStop(0, 'rgba(0,255,0,1)'), p.addColorStop(1, 'rgba(0,0,0,0'), (e.fillStyle = p);
                  } else (l = 4), (e.fillStyle = 'blue');
                  e.fillRect(u, s, l, l);
                }
              },
            },
  ...
  function(e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.updateSelectedHop = t.updateEyepieceView = t.updateView = t.getDeepSpaceObjects = t.getStars = void 0);
    var r = n(113),
      o = (function(e) {
  ...
  function(e, t, n) {
    ...
    var r = n(12),
      o = (n.n(r), n(22));
    n.n(o), n(80), n(63), n(119), n(178), 'function' == typeof Symbol && Symbol, Object;
  },
  function(e, t, n) {
    'use strict';
    var r = n(12),
      o = (n.n(r), n(22));
    n.n(o), n(80), n(63), n(119), n(178), Object;
  },
  function(e, t, n) {
    'use strict';
    var r = n(12);
  ...
  function(e, t, n) {
    ...
    function r() {
      ...
      switch (t.type) {
        ...
        case a.GET_STARS_FAILURE:
          return o({}, e, { stars: t.stars, starStatus: t.starStatus });
        case a.GET_DEEP_SPACE_SUCCESS:
        case a.GET_DEEP_SPACE_FAILURE:
          return o({}, e, { dsos: t.dsos });
        case a.UPDATE_VIEW:
          return o({}, e, { view: t.view });
        case a.UPDATE_EYEPIECE_VIEW:
          return o({}, e, { eyepieceView: t.view });
        case a.UPDATE_SELECTED_HOP:
          return o({}, e, { selectedHop: t.hop });
        default:
          return e;
      }
    }
    ...
    var i = n(113),
      ...
      l = (t.defaultState = {
        ...
        view: s,
        eyepieceView: c,
        starStatus: u.DEFAULT_SERVICE_STATUS,
  ...
  function(e, t, n) {
        ...
        function(n) {
          for (;;)
            switch ((n.prev = n.next)) {
              case 0:
                return (
                  console.log('calling getStars with action=', e),
                  (n.prev = 1),
                  (n.next = 4),
                  (0, c.call)(g, e.starQuery)
                );
              case 4:
                if (((t = n.sent), console.log('data for stars=', t), !(t && t.length > 0))) {
                  n.next = 11;
                  break;
                }
                return (
      ...
      return regeneratorRuntime.wrap(
        function(e) {
          for (;;)
            switch ((e.prev = e.next)) {
              case 0:
                return console.log('watch DSOs fired'), (e.next = 3), (0, c.call)(s.takeEvery, p.GET_DEEP_SPACE, a);
              case 3:
              case 'end':
                return e.stop();
            }
        ...
        function(n) {
          for (;;)
            switch ((n.prev = n.next)) {
              case 0:
                return (
                  console.log('calling getDSOs with action=', e), (n.prev = 1), (n.next = 4), (0, c.call)(m, e.catalog)
                );
              case 4:
                if (((t = n.sent), console.log('data for dsos=', t), !(t && t.length > 0))) {
                  n.next = 11;
                  break;
                }
                return (n.next = 9), (0, c.put)({ type: p.GET_DEEP_SPACE_SUCCESS, dsos: t });
              case 9:
                n.next = 13;
                break;
              case 11:
    ...
    var u = n(185),
      ...
      g = function(e) {
        return console.log('Searching db for stars matching', e), (0, l.loadStars)(e);
      },
      m = function(e) {
        return console.log('Searching db for dsos'), (0, l.loadDSOs)(e);
      };
  },
  function(e, t, n) {
    'use strict';
