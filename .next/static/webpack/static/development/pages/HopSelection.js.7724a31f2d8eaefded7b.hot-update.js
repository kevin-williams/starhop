...
var NavBar = function NavBar() {
  ...
  var pageTitle = router.pathname !== '/' ? " - ".concat(router.pathname.replace(/\//, '')) : '';
  console.log('pageTitle1', pageTitle);
  pageTitle = pageTitle.replace(/([A-Z])/, ' $1');
  console.log('pageTitle2', pageTitle);
  return __jsx(NavigationBar, {
    ...
    __self: this
  }, "Starhop", pageTitle), __jsx(next_link__WEBPACK_IMPORTED_MODULE_1___default.a, {
    href: "/About",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 30
...
//# sourceMappingURL=HopSelection.js.7724a31f2d8eaefded7b.hot-update.js.map